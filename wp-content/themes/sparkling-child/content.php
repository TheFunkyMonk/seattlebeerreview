	...
	<div class="blog-item-wrap">
		...
		<div class="post-inner-content">
			<header class="entry-header page-header">
				...
				<h1 class="entry-title"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?> - <?php $brewery = get_the_terms($post->ID, 'brewery'); echo $brewery[0]->name; ?></a></h1>

				<div class="beer-info"><h3><?php
				  include 'get-score.php';
				  echo $totalScore / 10 ?> -
