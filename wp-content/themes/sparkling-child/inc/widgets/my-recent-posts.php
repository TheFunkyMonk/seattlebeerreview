...
class my_recent_posts extends WP_Widget {
  ...
  public function __construct() {
    $widget_ops = array('classname' => 'my_recent_posts', 'description' => __( "Your site&#8217;s most recent Posts.") );
...
?>
    ...
    <?php while ( $r->have_posts() ) : $r->the_post();
      ...
      <li class="<?php echo "rating_" . ((round(($totalScore / 10) * 2)) / 2) * 10 ?>">
        <a href="<?php the_permalink(); ?>"><?php get_the_title() ? the_title() : the_ID(); ?><span><?php echo $totalScore / 10 ?></span></a>
      <?php if ( $show_date ) : ?>
